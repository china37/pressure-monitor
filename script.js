...
const ctxChart = document.getElementById('pressureChart').getContext('2d');
const chart = new Chart(ctxChart, {
  type: 'line',
  data: {
    labels: generateInitialTimestamps(),
    datasets: [
      { label: 'KneeLeft', data: [], borderColor: 'red', fill: false },
      { label: 'Bottom', data: [], borderColor: 'green', fill: false },
      { label: 'KneeRight', data: [], borderColor: 'blue', fill: false }
    ]
  },
  options: {
    responsive: true,
