...
// 🔄 ดึงข้อมูลแบบ real-time
  ...
  function updateSensorValues(data) {
    ...
    chartKneeLeft.options.scales.x.min = oneHourAgo;
    chartKneeLeft.options.scales.x.max = now;
    chartBottom.options.scales.x.min = oneHourAgo;
    chartBottom.options.scales.x.max = now;
    chartKneeRight.options.scales.x.min = oneHourAgo;
    chartKneeRight.options.scales.x.max = now;
